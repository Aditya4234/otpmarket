    ...
    return (
        <section className="relative w-full py-20 px-6 sm:px-16 bg-gradient-to-b from-[#050816] to-[#0a0f2e] overflow-hidden">
            ...
            <div className="max-w-5xl mx-auto relative z-10">
                ...
                >
                    {/* Main Content */}
                    <div className="bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-12 md:p-16 shadow-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <Link
                                href="/register"
                                className="bg-[#804dee] text-white py-4 px-10 rounded-full font-bold text-lg shadow-lg hover:bg-[#6b3dc9] transition-all transform hover:scale-105 hover:shadow-xl"
                            >
                                Create Account Now
                            </Link>
                        </div>
